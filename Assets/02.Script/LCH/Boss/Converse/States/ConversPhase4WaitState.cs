...
public class ConversPhase4WaitState : EntityState
{
    private Converse _converse;

    public ConversPhase4WaitState(Entity entity, AnimParamSO animParam) : base(entity, animParam)
    {
    ...
    private IEnumerator ChangePhase1State()
    {
        ...
        _converse.ChangeState(BossState.Phase4);
    }
}
